...
Try {
    ...
    [string]$appVendor = 'FourWinds Interactive'
    [string]$appName = 'Content Player'
    [string]$appVersion = '6.3.0.14876'
    [string]$appArch = 'x64'
    [string]$appLang = 'EN'
    [string]$appRevision = '01'
    [string]$appScriptVersion = '1.0.0'
    [string]$appScriptDate = '09/01/2023'
    ...
    If ($deploymentType -ine 'Uninstall' -and $deploymentType -ine 'Repair') {
        ...
        Show-InstallationWelcome -CloseApps 'signage,contentplayermonitor,contentplayerservice' -CheckDiskSpace -PersistPrompt
		...
		Copy-File -Path "$dirSupportFiles\Content Player.lnk" -Destination "C:\ProgramData\Microsoft\Windows\Start Menu\Programs\Startup"
    ...
    ElseIf ($deploymentType -ieq 'Uninstall') {
        ...
        Execute-MSI -Action Uninstall -Path '{2348A722-4B27-47FD-ADE0-19C70ED28A4C}'
        ...
        Remove-File -Path "C:\ProgramData\Microsoft\Windows\Start Menu\Programs\Startup\_signage.bat"
		Remove-File -Path "C:\ProgramData\Microsoft\Windows\Start Menu\Programs\Startup\Content Player.lnk"
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCC79HIsOonmAAdG
# CxCsW1oslkl7AS7RtIjhfsyjjjhAZqCCH8AwggVvMIIEV6ADAgECAhBI/JO0YFWU
...
# gjcCAQsxDjAMBgorBgEEAYI3AgEVMC8GCSqGSIb3DQEJBDEiBCCv/NbN8CrYWel0
# lH/GnzJ7YNgMB2MTCV0fwS/3FTCIGDANBgkqhkiG9w0BAQEFAASCAYBcEjQ3wpRY
# QYFyWYBmBW0G4dVdWaN9RqmluW7/YW7PKNg07jG+DH3AmHMhPUBxaDvNSr7NTbJD
# dQCegvQ6hjmYjciodIBAEM4LGxS5yD8G7retioyzbQQUCDHxO1X2YrRVORJqfepT
# AHdUFAjCPP8hO43zgwVm6eDNxim3wCqERgZU8G1K/UMNeFR9YVULirpO04NvOOQu
# eTRvzkf54Ofcjy9Ca7X/mfkrXyke7pKqkSxik4TT0nb8fy4BErk5ZnHybKzIviE2
# G5uLafoSQUugSVPvi+vgIDqJM9uUTGxtziXQSxx5nCdQbVZr3KwF1aDPyHXoQ70j
# hrG4MLxwdsOWfYxQm/N6WIG9Iw9lkiQBfoTyu5GYajyiiAAWExdCBvzygix4lBWc
# R4H3PANWhGgR9UkSnE61tUfBQhZLPLebix6T4UG05D5HysDuXayYRe5z7dSO8zZz
# z5WQp3zG5z58Z8Vk5nqQRnf92VojtwR42G/CDAE+1+XM5vJ7Wp2tUGahggNLMIID
...
# KoZIhvcNAQkDMQsGCSqGSIb3DQEHATAcBgkqhkiG9w0BCQUxDxcNMjMwOTAxMTgz
# ODQxWjA/BgkqhkiG9w0BCQQxMgQwBYn2cVQQIQw2FgmWVt37F2ILh3WvJcLsoJHZ
# 4dML5ShLZ1y3lWiqW36lSa6IGabiMA0GCSqGSIb3DQEBAQUABIICAAZHL2OhGlvB
# CrrGw1kXn3Irmiv6WnNcXA6XJat1C46Rm8pNBB2jl72Daj95V3WAejog4m330Gub
# zg0tKP6nH+5UfcVmUq07weCYVXXtPKdi/67ZlSzadM1l4/k4mwvDJf+yw279Txba
# xxOkAwN2nvZiPGhb8+dhY4mn0wUZwXMZ11Uq5GsTRV/SX+6OEt08Y2eWO60Est34
# iKkzTdtDH7e8Ij6DSq6GA3VYqC0Tu/FSjylf7MDgFC3/aaT86mhr6UU0ZwlcdptS
# pmZNwUuamimCZ1eQpHfQfbea2zsw+n74MnfmW9kMZ7/+o+x2d/ZBc2/UQyoCTY82
# ZgSiMHbAt+fOTm2J0MaRTFn0nQFAEZ4Og+q81Cpv0oT7sRlVR54GB9CBUrCX9j/u
# raqUN7SWq6+saBgp5zph3txG0oeUVN4vcWUEh3qktb3/pla9CHyhH/JKY1WqQrJ0
# mNA3rj+/kVXh0Pb93tZtdnLBYaU1E4he1uf5b6gKu06clSoID0lNaJ5SzTRGWDku
# kcJlua7CTOfQRVIYFThcXVDxOyteTvn7GNxCAVGzfWPzwmd39TaLG27GyllYv7Bk
# KI9tg2UKGk+N7JxpIGwDhvxMa+fgDfTB83VO68FK3w93m5VGC2uyiRSgqFYNgpTL
# 9xu7WetsPgdo0l28erH/7f5O+alzX4Xf
